<script lang="ts">
	import CalenderIcon from '../Icons/CalenderIcon.svelte';
...
>
	<div
		class="rounded-md flex-col flex justify-center hidden items-center dark:text-black font-semibold space-y-4 shadow-md absolute p-2 bg-red-50"
		data-popup="addPopup"
	>
	...
	<div class="flex justify-center items-center space-x-10 mb-6">
		<div>
			<a href="/"><div class="w-6 h-6 dark:fill-white"><HomeIcon /></div></a>
		</div>
		<div>
